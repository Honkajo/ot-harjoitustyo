...
def register():
    ...
    password_entry.pack()
    Label(register_screen, text="").pack()
    Button(register_screen, text="Rekisteröidy", width=10, height=1, command = register_user).pack()
...
def login():
    ...
    Label(login_screen, text="").pack()
    Button(login_screen, text="Kirjaudu", width=10, height=1, command=login_verify).pack()
...
def register_user():
    ...
    Label(register_screen, text="Rekisteröinti onnistui", fg="green", font=("calibri", 11)).pack()
...
def password_not_recognised():
    ...
    Button(password_not_recog_screen, text="OK", command=delete_password_not_recognised_screen).pack()
...
def open_user_account():
    ...
    if not os.path.exists("loggedin.txt"):
        ...
        Button(user_account_screen, text="Sulje", command=user_account_screen.destroy).pack()
...
def main_account_screen():
    ...
    Label(text="").pack()
    Button(text="Rekisteröidy", height="2", width="30", command = register).pack()
